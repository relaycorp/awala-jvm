...
class SessionPublicKeyStoreTest {
    ...
    inner class Save {
        ...
        inner class CreationTime {
            @Test
            fun `Now should be used by default`() =
                runTest {
            ...
            @Test
            fun `Any explicit time should be honored`() =
                runTest {
                    val store = MockSessionPublicKeyStore()
            ...
            @Test
            fun `Time should be stored as UTC`() =
                runTest {
    ...
    inner class Retrieve {
        ...
        @Test
        fun `Exception should be thrown if key for recipient does not exist`() =
            runTest {
                val store = MockSessionPublicKeyStore()
